        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form action="{{ route('daftarproses') }}" method="POST" class="user pt-3 ">
                @csrf
                ...
                <div class="form-group">
                  <label for="exampleInput">Daftar sebagai</label>
                  <div class="input-group">
                    <div class="input-group-prepend bg-transparent">
                ...
                <div class="my-3 text-center">
                  <button class="btn-primary btn-lg font-weight-medium auth-form-btn" type="submit">DAFTAR</button>
                </div>
                
                <div class="text-center mt-4 font-weight-light ">
                  Sudah punya akun  silahkan <a href="{{ route('login') }}" class="text-info ">Masuk</a>
                </div>
              </form>
            </div>
          </div>
